...
public partial class MvcdbContext : DbContext
{
    ...
    public void Seed()
    {
        try
        {
            ...
            Author.AddRange(
                new Author { Name = "増田 智明", Age = 49, AddressId = 1 },
                new Author { Name = "○田 太郎", Age = 20, AddressId = 2 },
                new Author { Name = "×田 次郎", Age = 30, AddressId = 3 },
                new Author { Name = "ジェラルド・ワインバーグ", Age = 0, AddressId = 4 },
                new Author { Name = "トム・デマルコ", Age = 0, AddressId = 4 },
                new Author { Name = "カーニハン＆リッチー", Age = 0, AddressId = 4 },
                new Author { Name = "ストラウストラップ", Age = 0, AddressId = 4 },
                new Author { Name = "フレデリック・ブルックス・ジュニア", Age = 0, AddressId = 4 }
                );
            this.SaveChanges();

            Book.AddRange(
                new Book { AuthorId = 1, PublisherId = 1, Title = "ASP.NET Core MVC 入門", ISBN = "978-4-82229-888-3", Price = 2000 },
                new Book { AuthorId = 1, PublisherId = 1, Title = ".NET MAUI 入門", ISBN = "978-4-82229-834-0", Price = 3200 },
