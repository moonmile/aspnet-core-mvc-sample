...
namespace SampleListDetailMvc.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(MvcdbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publisher != null ? 
                          ...
                          Problem("Entity set 'MvcdbContext.Publisher'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcdbContext.Publisher'  is null.");
            }
            var publisher = await _context.Publisher.FindAsync(id);
            if (publisher != null)
            {
